 ...
 <?php while (have_posts()) : the_post(); ?>
 		<div id="content" class="content">
			<div class="section-page-title">
                ...
                <h5><?php echo esc_html(get_theme_mod('pwt_blog_page',__( 'Latest Reports', "causes"))); ?></h5>
					</div>
				</div>
			</div>
			<div class="section-inner-page">
				<div class="container">
                    ...
                    <p class="meta"><strong><?php the_author(); ?></strong></p>
                    <p>Date Received: <strong><?php the_time( get_option( 'date_format' ) ); ?></strong></p>
                    <h5>Files attached:</h5><p><?php echo do_shortcode("[usp_attachments]"); ?></p>
										<h5>Comments:</h5>
                    <?php the_content(); ?>
